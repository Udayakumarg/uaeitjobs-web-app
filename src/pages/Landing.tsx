    ...
    <div>
      ...
      <section className="hero-image relative overflow-hidden px-4 pb-32 pt-20 text-white sm:px-6 lg:px-8 lg:pt-28">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl animate-fade-in-up">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-blue-50 backdrop-blur">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-blue-100/90">
      ...
      <section className="mx-auto -mt-20 grid max-w-7xl gap-4 px-4 pb-16 sm:grid-cols-3 sm:px-6 lg:px-8">
        {[
          ...
          >
            <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-100">
              <Icon size={22} />
            </span>
            <div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-blue-700">Explore</p>
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">
              Roles by speciality
            </h2>
          </div>
          <Link to="/jobs" className="text-sm font-semibold text-blue-700 hover:text-blue-800">
            View all →
          </Link>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {CATEGORIES.map(({ icon: Icon, label, count }) => (
            ...
            >
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-blue-50 text-blue-700 ring-1 ring-inset ring-blue-100 transition group-hover:bg-blue-100">
                <Icon size={20} />
              </span>
              <div>
      ...
      {featured.length > 0 ? (
        <section className="bg-white/60 py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 flex items-end justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-wider text-blue-700">Latest</p>
                <h2 className="mt-2 text-3xl font-bold tracking-tight text-slate-950">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {featured.map((job) => (
                <Link
                  key={job.id}
                  to={`/jobs/${job.id}`}
                  className="card-glow flex flex-col gap-3 p-6"
                >
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 px-8 py-14 text-white shadow-lg sm:px-14">
